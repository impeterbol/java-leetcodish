//Andrea Villalobos / Feb 22 // CSS 142
...
public class AndreaTaskFeb22 {
    ...
    public static int [][] transpond(int[][] someArr, int[] rowsCols){
        ...
        for(int rowS=0,rowN=0;rowS<newR;rowS++,rowN++){
            for(int colS=0,colN=0;colS<newC;colS++,colN++){
                // System.out.println("this is col n "+ colN + " this is row n "+ rowN);
                // System.out.println("this is col s "+ colS + " this is row s "+ rowS);
                // System.out.println();
